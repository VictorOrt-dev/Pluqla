/**
 * Composant Card unifié pour l'application Pluqla
...
const CARD_VARIANTS = {
  ...
  gradient: 'bg-gradient-to-br from-blue-50 to-red-50 dark:from-blue-900/20 dark:to-red-900/20 border border-blue-200 dark:border-blue-800'
};
