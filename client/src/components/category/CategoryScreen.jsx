  ...
  const getTabsForCategory = () => {
    ...
    switch (category) {
      case 'habits':
        return [
          ...baseTabs,
          { key: 'analyze', label: 'Photo', icon: '📸', color: 'red' },
            ...
            <div className="space-y-3">
              <div>
                <input
                  ...
                  className={`w-full px-4 py-3 ${darkMode ? 'bg-gray-900 text-white border-gray-700 focus:border-red-500' : 'bg-white text-black border-gray-300 focus:border-red-500'} border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all`}
                />
              </div>
