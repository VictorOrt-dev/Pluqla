    ...
    return (
      <div className="space-y-6">
        <div className={`text-center p-8 rounded-2xl ${
          ...
          <div className="animate-spin w-8 h-8 border-3 border-red-500 border-t-transparent rounded-full mx-auto mb-4"></div>
      ...
      <div className={`glass-effect p-6 rounded-2xl ${
        ...
        {likedItems.size > 0 && (
          <div className={`p-3 rounded-xl mb-4 ${
            ...
            <p className={`text-sm ${
              darkMode ? 'text-orange-300' : 'text-red-700'
            }`}>
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity ${
                    ...
                    <div className="absolute top-3 right-3 flex space-x-2">
                      ...
                      <button
                        ...
                        className={`p-2 rounded-full bg-red-700/90 text-white backdrop-blur-sm transition-all ${
                          prefersReducedMotion ? 'duration-150' : 'duration-300'
                        } transform ${
                          prefersReducedMotion ? 'hover:scale-105' : 'hover:scale-110'
                        } hover:bg-red-800/90 shadow-lg shadow-red-500/25`}
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className={`py-2 px-3 rounded-xl text-sm font-medium transition-all ${
                        ...
                        darkMode
                          ? 'bg-red-800/20 text-orange-400 hover:bg-red-800/30 border border-red-600/30'
                          : 'bg-red-50 text-red-800 hover:bg-orange-100 border border-orange-200'
                      }`}
                    >
                      🔍 Analyser
                    </button>
