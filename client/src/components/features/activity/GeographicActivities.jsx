    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-3">
          <div className="p-2.5 pluqla-btn-primary rounded-xl">
      ...
      {isLoading && (
        <div className={`group relative p-8 backdrop-blur-xl rounded-3xl border transition-all duration-500 ${
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-red-500/5 rounded-3xl"></div>
          <div className="relative z-10 text-center space-y-4">
            <div className="relative">
              <div className="animate-spin w-12 h-12 border-3 border-red-500/30 border-t-blue-500 rounded-full mx-auto"></div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-start gap-4">
                {/* Location Icon */}
                <div className="p-3 pluqla-btn-primary rounded-2xl shadow-lg">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-3 mb-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        <span className="text-xs pluqla-btn-primary text-white px-3 py-1 rounded-full font-semibold">
                          🤖 IA Géo
                        </span>
                        {activity.category && (
                  ...
                  <div className="flex gap-3">
                    <button className="flex-1 py-3 pluqla-btn-primary text-white rounded-2xl text-sm font-semibold transition-all duration-300 transform hover:scale-[1.02] hover:from-blue-600 hover:to-red-700 shadow-lg hover:shadow-xl">
                    ...
                    <button className={`px-4 py-3 rounded-2xl text-sm font-semibold transition-all duration-300 transform hover:scale-105 border-2 ${
                      darkMode
                        ...
                        : 'border-red-500/50 text-red-600 hover:bg-blue-50'
                    } shadow-md hover:shadow-lg`}>
                      <span className="text-lg">💾</span>
                    </button>
                  </div>
          ...
          <div className={`group relative p-12 backdrop-blur-xl rounded-3xl border transition-all duration-500 ${
            ...
            <div className="relative z-10 text-center space-y-6">
              <div className="relative">
                ...
                <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 to-red-500/20 rounded-full blur-xl animate-pulse"></div>
              </div>
              ...
              <button className="px-6 py-3 pluqla-btn-primary text-white rounded-2xl text-sm font-semibold transition-all duration-300 transform hover:scale-105 hover:from-blue-600 hover:to-red-700 shadow-lg hover:shadow-xl">
