...
const ProgressionDetailScreen = ({ userData, darkMode }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-red-50/20 dark:bg-black transition-colors duration-300">
      {/* Header */}
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-lg">
          <div className="text-center mb-6">
            <div className="w-24 h-24 bg-gradient-to-br pluqla-gradient-main rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div className="mb-4">
            ...
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
              <div
                className="pluqla-btn-primary h-3 rounded-full transition-all duration-500"
