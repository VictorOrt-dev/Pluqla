...
class PWAService {
    ...
    if (isIOS) {
      instructions = `
        <div class="install-instructions ios">
          <h3>📱 Installer Pluqla sur iOS</h3>
          <ol>
      ...
      instructions = `
        <div class="install-instructions android">
          <h3>📱 Installer Pluqla sur Android</h3>
          <ol>
      ...
      instructions = `
        <div class="install-instructions desktop">
          <h3>💻 Installer Pluqla sur desktop</h3>
          <ol>
            <li>Cliquez sur l'icône d'installation dans la barre d'adresse</li>
            <li>Ou utilisez le menu Chrome > "Installer Pluqla"</li>
          </ol>
        </div>
      `;
    }
  ...
  showInstallSuccessMessage() {
    this.showNotification('Installation réussie !', {
      body: 'Pluqla est maintenant installé sur votre appareil',
      tag: 'install-success'
    });
  }
