  ...
  if (!accounts || accounts.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-40 text-gray-500 dark:text-gray-400">
        ...
        <button className="mt-3 text-xs bg-blue-600 text-white px-3 py-1 rounded-lg hover:bg-blue-700 transition-colors">
    ...
    <div className="space-y-3 max-h-80 overflow-y-auto">
      ...
      <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-600">
        ...
        <div className="flex space-x-2 mt-3">
          <button className="flex-1 text-xs bg-blue-600 text-white py-2 px-3 rounded-lg hover:bg-blue-700 transition-colors">
