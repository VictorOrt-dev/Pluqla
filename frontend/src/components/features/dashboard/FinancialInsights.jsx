      ...
      <div className="mt-4 pt-3 border-t border-gray-200 dark:border-gray-600">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-1 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span className="text-blue-600">Claude</span>
          </div>

          <button className="text-xs bg-gradient-to-r from-blue-600 to-purple-600 text-white px-3 py-1 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all">
