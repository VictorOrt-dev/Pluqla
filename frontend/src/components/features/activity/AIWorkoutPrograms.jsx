                  ...
                  {program.sessions && (
                    <div className={`p-4 backdrop-blur-sm rounded-2xl border mb-4 ${
                      darkMode
                        ...
                        : 'bg-gradient-to-r from-indigo-50/80 to-purple-50/80 border-indigo-200/60'
                    } shadow-lg`}>
      ...
      {combinedPrograms.length === 0 && !isLoading && (
        <div className={`group relative p-12 backdrop-blur-xl rounded-3xl border transition-all duration-500 ${
          ...
          <div className="relative z-10 text-center space-y-6">
            ...
            <button className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-2xl text-sm font-semibold transition-all duration-300 transform hover:scale-105 hover:from-indigo-600 hover:to-purple-700 shadow-lg hover:shadow-xl">
