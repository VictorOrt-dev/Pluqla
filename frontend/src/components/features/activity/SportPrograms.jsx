          ...
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <button
                ...
                className="group w-full sm:w-auto sm:px-8 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-2xl text-sm font-semibold transition-all duration-300 transform hover:scale-[1.02] hover:from-indigo-600 hover:to-purple-700 shadow-lg hover:shadow-xl"
              >
        ...
        <div className={`group relative p-12 backdrop-blur-xl rounded-3xl border transition-all duration-500 ${
          ...
          <div className="relative z-10 text-center space-y-6">
            <div className="relative">
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 rounded-full blur-xl animate-pulse"></div>
            </div>
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-2xl text-sm font-semibold transition-all duration-300 transform hover:scale-105 hover:from-indigo-600 hover:to-purple-700 shadow-lg hover:shadow-xl"
            >
