...
const LevelProgress = memo(({ userData, showDetails = false }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      <div
        className="w-6 h-6 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center shadow-sm"
      ...
      {nextLevel && (
        <div className="w-8 bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
          <div
            className="bg-gradient-to-r from-purple-500 to-blue-600 h-1.5 rounded-full transition-all duration-300"
