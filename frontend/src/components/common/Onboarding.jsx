      ...
      <div className="fixed inset-0 z-50 bg-black/20 backdrop-blur-sm animate-fade-in">
        ...
        <div className={`fixed z-50 max-w-sm p-6 rounded-2xl shadow-2xl border transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              ...
              <button
                onClick={nextStep}
                className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all transform hover:scale-105 shadow-lg shadow-purple-500/25"
              >
        ...
        {currentStepData.highlight && (
          <div className="fixed inset-0 pointer-events-none">
            <div
              className="absolute border-2 border-purple-500 rounded-xl animate-pulse shadow-lg shadow-purple-500/50"
              style={{
