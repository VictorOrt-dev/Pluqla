// Service Worker avancé pour +Clair PWA
...
function createOfflinePage() {
  const offlineHTML = `
    ...
    <head>
      ...
      <title>+Clair - Mode hors-ligne</title>
      <style>
    ...
    <body>
      ...
      <h1 class="offline-title">+Clair</h1>
...
function setupNotifications() {
  ...
  self.registration.showNotification('Service activé', {
    body: '+Clair est maintenant disponible hors-ligne !',
    icon: '/logo192.png',
    badge: '/logo192.png',
    tag: 'service-ready',
    silent: true,
...
console.log('🎉 +Clair Service Worker chargé et prêt !');